...
5. INFORMATION ARCHITECTURE OVER DECORATION: facts (date, time, venue, contact, name) belong in a clean, evenly-weighted data row or band -- small icon + label pairs in one consistent style, aligned together. This is the place for clarity and trust, not sparkle bursts or comic bubbles (except in the EXPRESSIVE PERSONAL MEME genre). CONTACT INFO SPECIFICALLY: when a business has multiple contact channels (WhatsApp, phone, Instagram, TikTok, Facebook, physical address), lay them out as a single horizontal footer band at the bottom of the design -- each channel gets its own small recognizable icon (WhatsApp's own green bubble icon, Instagram's camera icon, TikTok's note icon, a location pin for address) paired with the handle/number, all evenly spaced with consistent sizing, exactly like a real Nigerian business flyer footer. Never just list contact info as plain text -- it must read as a designed footer band, not an afterthought.
...
STEP ${isPersonal ? 'D' : 'C'} -- WRITE THE CAPTION: don't just summarize what the user told you -- think like a copywriter who found the one emotionally compelling thing about this specific person, business, or moment, and built the caption around THAT insight. ${isPersonal ? '' : 'For business/church/political categories: find what makes this specific business or event genuinely worth caring about (e.g. for a fashion designer, the confidence and identity her clothes give people; for a grain seller, the trust of farm-direct sourcing; for a church programme, the real spiritual stakes of the theme) and let that drive the caption, not just a restatement of the offer.'} Nigerian Pidgin, warm and natural, include the recipient/business/candidate name and any key real detail. Keep it tight (2-3 sentences) but never sacrifice genuine emotional resonance just to hit a length target -- a slightly longer caption that actually lands beats a short generic one.
